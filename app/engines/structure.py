...
def score_structure(md: MarketData) -> ScoreExplanation:
    ...
    factors = [
        EvidenceFactor("Spread Quality", round(spread_score, 1), 0.25,
                        ...
                        "Market Microstructure", research_key="Structure Score"),
        ...
        EvidenceFactor("Range Expansion", round(range_score, 1), 0.20,
                        "Daily range as a percentage of price — a volatility-regime proxy.",
                        "Auction Market Theory", research_key="Structure Score"),
    ...
    return ScoreExplanation(
        score_name="Structure Score",
        value=round(value, 1),
        confidence=round(confidence, 2),
        methodology="Weighted combination of spread quality, relative volume, range expansion, VWAP relationship, and gap quality.",
